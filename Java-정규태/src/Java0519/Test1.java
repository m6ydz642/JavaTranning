...
//		출처: https://hyeonstorage.tistory.com/168 [개발이 하고 싶어요]
		/* 기본형 데이터 타입을 객체로 사용할 수 있도록 하는 클래스
		 * -> 기본형 타입의 본질은 그대로 두고, 인터페이스만 제공해서 사용하는 것 
		 * 
		 * [기본형 -> 참조형]
		 * boolean -> Boolean
		 * char -> Character
		...
		/*
		오토 박싱 & 오토 언박싱
		-> 박싱 : 값형태의 데이터(기본형타입)가 Wrapper 클래스 (참조형 타입) 변환하는 것
		-> 언박싱 : Wrapper클래스 데이터가 값 형태의 데이터로 변환
		-> JDK 6.0이후에는 자동으로 박싱, 언박싱이 처리된다.
