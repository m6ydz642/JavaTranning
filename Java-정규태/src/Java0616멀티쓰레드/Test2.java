...
class ItwillThread extends Thread { // Java.lang.Thread 클래스를 상속
...
System.out.println(Thread.currentThread().getName());
		...
		// -> main() : 하나의 쓰레드
		ItwillThread t = new ItwillThread();
//		ItwillThread th2 = new ItwillThread();
//		ItwillThread th3 = new ItwillThread();
//		ItwillThread th4 = new ItwillThread();
		
		ItwillThread th2 = new ItwillThread("1번쓰레드");
		ItwillThread th3 = new ItwillThread("2번쓰레드");
		ItwillThread th4 = new ItwillThread("3번쓰레드");
		t.run();
		// t.start(); // 쓰레드 실행 : run() 직접 실행X, start() 통해서 간접 호출	
		th2.start();
		th3.start();
		th4.start();
		System.out.println();
